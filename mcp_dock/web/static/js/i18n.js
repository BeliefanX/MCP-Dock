    ...
    constructor() {
        ...
        this.translations = {
            zh: {
                ...
                'placeholder.service.args.json': '["-y", "@modelcontextprotocol/server-filesystem"]',
                'placeholder.service.env': 'KEY1=value1\\nKEY2=value2',
                'placeholder.service.env.json': '{"NODE_ENV": "production", "API_KEY": "your-key"}',
                'placeholder.service.url': 'http://localhost:3000/sse',
                'placeholder.service.headers': '{"Content-Type": "application/json", "Authorization": "Bearer token"}',
